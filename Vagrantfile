...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "jw7698-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/attchefpractice"
  #   chef.validation_client_name = "attchefpractice-validator"
  #   chef.validation_key_path = ".chef/attchefpractice-validator.pem"
  # end
end
